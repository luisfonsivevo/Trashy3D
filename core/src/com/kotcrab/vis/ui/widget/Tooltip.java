...
public class Tooltip extends VisTable {
	...
	private Tooltip (Builder builder) {
		...
		if (style == null) style = Dialog.getSkin().get("default", TooltipStyle.class);
	...
	public Tooltip (String styleName) {
		super(true);
		init(Dialog.getSkin().get(styleName, TooltipStyle.class), null, null);
	}
	...
	public static class Builder {
		...
		public Builder style (String styleName) {
			return style(Dialog.getSkin().get(styleName, TooltipStyle.class));
		}
