...
public class VisTextField extends Widget implements Disableable, Focusable, BorderOwner {
	...
	public VisTextField () {
		this("", Dialog.getSkin().get(VisTextFieldStyle.class));
	}

	public VisTextField (String text) {
		this(text, Dialog.getSkin().get(VisTextFieldStyle.class));
	}

	public VisTextField (String text, String styleName) {
		this(text, Dialog.getSkin().get(styleName, VisTextFieldStyle.class));
	}
